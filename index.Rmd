...
I will be working with the census data for my dataset. I want to work with the Hispanic community as of right now. However, first I want to explore data using th census, and choose a topic that interest me. This visualization is of income in Boston which is the city I want to focus on as well as the topic. The final visualization I also included is using the cenusus to explore race. My hope is to eventually combine all these moving parts. However, for now I have these two final visualizations for milestone 3. 
...
boston_race2 <- boston_race|>
  ...
  mutate(White_percentage = White/total*100)|>
  mutate(Black_percentage = Black/total*100)
...
This visulation shows the Hispanic population of MA. I want to be able to look at income and immigration using the census data to answer my question of does race effect income level. 
